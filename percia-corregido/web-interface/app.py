...
def api_cycle_start():
    ...
    try:
        ...
        # Actualizar snapshot
        snapshot_file = MCP_DIR / "snapshot.json"
        snapshot = load_json_file(snapshot_file) or {"proposals": [], "challenges": [], "decisions": []}
...
# ============================================================
# ENDPOINT 10: Governance Decision
# ============================================================
